window.onload = function () {
  var rankData = window.DATA.rank;
  var i;
  for(i=0; i<10; i++) {
    $('#pp-table-pg-'+i).append($('#player-info-tmp').render([{'name':rankData.pg[i].name}]));
    $('#pp-table-pg-'+i+' > .player-name').width(window.innerWidth/5-11);
    ...
    $('#pp-table-sg-'+i+' > .player-name').width(window.innerWidth/5-11);
    ...
    $('#pp-table-sf-'+i+' > .player-name').width(window.innerWidth/5-11);
    ...
    $('#pp-table-pf-'+i+' > .player-name').width(window.innerWidth/5-11);
    ...
    $('#pp-table-c-'+i+' > .player-name').width(window.innerWidth/5-11);
